...
entry:
  ...
  %3 = load i32, i32* %a, align 4, !dbg !84
  %4 = load i32, i32* %b, align 4, !dbg !85
  %arraydecay = getelementptr inbounds [100 x i8], [100 x i8]* %c, i64 0, i64 0, !dbg !86
  call void @fuzzMe(i32 %3, i32 %4, i8* %arraydecay), !dbg !87
  ret i32 0, !dbg !88
}
...
!84 = !DILocation(line: 37, column: 12, scope: !66)
!85 = !DILocation(line: 37, column: 15, scope: !66)
!86 = !DILocation(line: 37, column: 18, scope: !66)
!87 = !DILocation(line: 37, column: 5, scope: !66)
!88 = !DILocation(line: 39, column: 5, scope: !66)
